...
class CoinigyREST:
    ...
    def orderbook(self, one,two):
        return self.request('private/exchanges/BINA/markets/{baseCurrCode}/{quoteCurrCode}/depth'.format(baseCurrCode=one, quoteCurrCode=two))
...
if __name__ == "__main__":
    ...
    credentials.secret = "e02aba074c15401888b8438a6e609a29"
    credentials.endpoint = "https://api.coinigy.com/api/v2"
    cr = CoinigyREST(credentials)
    print(cr.orderbook('BTC', 'USDT'))
